...
struct CompanionPanelView: View {
    ...
    private var settingsSection: some View {
        VStack(spacing: 2) {
            // Dedicated permissions helper UX: per-permission Grant + Settings
            // actions plus a prominent bundle-path card with Reveal in Finder.
            PermissionsSetupView(companionManager: companionManager)
